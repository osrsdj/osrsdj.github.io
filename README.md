...
You don't need GitHub Pages to use this — `DrugBoxInsert.html` is fully self-contained. Just open it directly in a browser. All packing, dragging, and SVG export runs client-side; no server or network access needed.
